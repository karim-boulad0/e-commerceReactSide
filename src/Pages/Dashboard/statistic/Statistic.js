...
export default function Statistic() {
    ...
    useEffect(() => {
        Axios.get(
            `/dashboard/order/statistic/${selectedMonthWithYear.getDate()}/${selectedMonthWithYear.getMonth() + 1
        ...
        <Container>
            {IsGet && (<>
                ...
                <Row className="mt-4">
                    ...
                    <Col md={6}>
                        <label className="mb-2 text-primary">Select Month and Year:</label>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    ...
                                    <span className="text-primary">
                                        {statistic.YearlyMonthlyDailyOrders.totalPrice
                                        } $
                                    </span>
                                </Card.Text>
                                <Card.Text>
                ...
                <hr></hr>
                <hr></hr>
                <Alert onClick={handleAlertClick} variant={"primary"} className="mt-3">
